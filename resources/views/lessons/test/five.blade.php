...
<section class="px-4 pt-40 pb-32 relative ">
  <div class="absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat opacity-80 bg-fixed" style="background-image:url(storage/image/back5.png)"></div>
...
<div class="max-w-4xl mx-auto p-8">
    <h1 class="text-4xl text-center font-bold mb-8">Тест №5</h1>
    ...
    <div class="relative rounded-xl shadow-xl">
        ...
        <div class="sticky mb-5 top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl">
            <div class="items-center justify-center h-1/2 pb-4" >
                <!-- 1 -->
                <h3 class="text-2xl mx-auto text-center font-bold my-8 ">Какая основная причина популярности паттернов в дизайне?</h3>
        ...
        {{-- Вопрос 2 --}}
        <div class="sticky mb-5  top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl bg-cover" style="background-image: url('img/sixth/3.png');">
            <div class="items-center justify-center h-1/2 pb-4" >
                <!-- 1 -->
                <h3 class="text-2xl mx-auto text-white text-center font-bold my-8 ">Какой это вид паттерна?</h3>
        ...
        {{-- Вопрос 3 --}}
        <div class="sticky mb-2  top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl bg-cover" style="background-image: url('img/sixth/8.png');">
            <div class="items-center justify-center h-1/2 pb-4" >
                <!-- 3 -->
                <h3 class="text-2xl mx-auto text-center font-bold my-8 ">Какой это вид паттерна? </h3>
        ...
        <div class="sticky mb-2  top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl bg-white">
            <div class="items-center justify-center h-1/2 pb-4" >
                <!-- 3 -->
                <h3 class="text-2xl mx-auto text-center font-bold my-8 ">Где используется паттерн с ипользованием типографики?</h3>
        ...
        <div class="sticky mb-1  top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl bg-white">
            <div class="items-center justify-center h-1/2 pb-4" >
                <!-- 1 -->
                <h3 class="text-2xl mx-auto text-center font-bold my-8 ">Что вы станете использовать при создании паттерна?</h3>
        ...
        <div class="sticky mb-1  top-0 h-1/2 flex flex-col items-center justify-center border-slate-500 border-2 rounded-xl bg-white">
          <div class="items-center justify-center h-1/2 pb-4" >
              <!-- 1 -->
              <h3 class="text-2xl mx-auto text-center font-bold my-8 ">Стойт ли использовать паттерн в качестве фона на сате компании?</h3>
                            ...
                            <div class="w-60 max-w-xl rounded-md bg-white  p-5 text-gray-600  ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                              <div class="flex flex-col gap-1">
                                <div class="flex items-center justify-between">
                                    ...
                                    <P>Да, но в умеренном количестве </P>
        ...
        <div class="container mx-auto px-4 mt-10">
          <nav class="flex flex-row flex-nowrap justify-between md:justify-center items-center " aria-label="Pagination">
              ...
              <a class="hidden md:flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-gray-200 bg-white hover:border-gray-300 "
                  ...
                  <button type="submit" class=" w-full h-full" href="{{route("2test")}}">6</button>
              </a>
              <a class="hidden md:flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-gray-200 bg-white hover:border-gray-300 "
